...
class UserImageAssign extends StatefulWidget {
  String localUser;
  List imageData;

  UserImageAssign({Key key, @required this.localUser, this.imageData})
      : super(key: key);
  ...
  @override
  _UserImageAssignState createState() => _UserImageAssignState();
}

class _UserImageAssignState extends State<UserImageAssign> {
